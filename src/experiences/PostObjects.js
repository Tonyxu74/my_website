export const SmartStop = {
    ...
    'image_urls': [`${process.env.PUBLIC_URL}/smartstop_small.jpg`],
    'body': [
        ...
        'My role in this project was getting the computer vision software working. Over the 48 (very long) hours, I coded up and trained a PyTorch segmentation network to recognize the silhouettes of cars, and sped up training and detection with parallel processing and CUDA. We used the Berkeley DeepDrive car bounding box dataset, and you can see one of our nighttime segmentations <a target="_blank" class="ExperiencesLink" href=' + `${process.env.PUBLIC_URL}/smartstop_comb.png` + '>here</a>. The Raspberry Pi took images, sent them with SCP to my laptop, which consolidated information, and told the Pi whether it was safe to cross the street or not. ',
